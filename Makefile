...
#    Updated: 2021/03/18 23:34:09 by mde-figu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libftprintf.a

SRC = ft_printf.c utils/parameters_for_print.c utils/get_parameters.c \
...
OBJ = ft_printf.o parameters_for_print.o get_parameters.o \
